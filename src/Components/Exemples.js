        ...
        <h1>Exemples</h1>
            <div className="exemplesFlex">
                ...
                <div className="e2">
                    ...
                    <p>System Defender era un joc i un sistema de seguretat per a l' Elite Penguin Force , llançat el 14 de gener de 2011. [1] Tots els agents de l'EPF podien jugar a aquest joc a la sala de comandaments de l'EPF . Es va utilitzar per defensar l'ordinador EPF Mainframe de les amenaces. System Defender era un joc de Tower Defense .</p>
                    <img src='./clubPenguin.png' alt="club_penguin"/>1
